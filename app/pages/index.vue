<template>
            ...
            <div class="grid md:flex md:flex-wrap justify-center gap-8 ">
                ...
                <div class="bg-white block max-w-md md:w-md md:max-w-sm h-[500px] rounded-[10px] shadow-xl">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <a @click="navigateTo('/projectdetails')" class="inline-flex items-center text-white bg-[#36449c] rounded-md hover:bg-[#5564c3] focus:ring-2 shadow-xs font-medium leading-5 text-sm px-4 py-2.5 focus:outline-none">
                            En savoir plus
                            <svg class="w-4 h-4 ms-1.5 rtl:rotate-180 -me-0.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m14 0-4 4m4-4-4-4"/></svg>
                        </a>
                    </div>
    ...
    <footer id="contact" class="grid lg:flex  min:w-screen min-h-screen md:h-screen bg-white px-5 md:px-10 md:pt-15 md:gap-15">
        ...
        <div class="relative flex flex-col min-h-screen text-left ">
            ...
            <h1 class="poppins text-7xl md:text-9xl"> Merci de votre <span class="Birthstone-Casual-Regular text-[8rem] md:ml-0 md:text-[12rem] text-[#36449c]">visite</span></h1>
            ...
            <p  class="poppins flex items-center gap-2 text-4xl text-black mt-10">

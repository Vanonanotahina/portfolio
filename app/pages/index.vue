    ...
    <main class="overflow-x-hidden">
        <section class="feature-card-wrapper relative h-screen w-screen">
            <div data-aos="flip-up" class="feature-card absolute w-[80%] md:w-[60%] lg:w-[60%] h-[42%] md:h-[45%] lg:h-[40%] left-1/2 top-3/4 -translate-x-1/2 -translate-y-3/4 rounded-[10px] border-2 border-white flex text-center items-center sm:text-left md:text-center text-[#0e0e0e] p-10">
                <p class="text-white text-lg sm:text-[2.1rem] md:text-[2.2rem]">Je transforme des idées en applications fonctionnelles et élégantes, en alliant sérieux, créativité et apprentissage constant.</p>
    ...
    <footer id="contact" class="grid md:flex  min:w-screen min-h-screen md:h-screen bg-white px-5 md:px-10 md:pt-15 md:gap-15">
        ...
        <div class="relative flex flex-col min-h-screen text-left ">
            ...
            <p data-aos="fade-right"  data-aos-duration="1000" class="poppins flex items-center gap-2 text-4xl text-black mt-10">
                <a href="/files/carino_s_cv.pdf" download="">My CV</a>
